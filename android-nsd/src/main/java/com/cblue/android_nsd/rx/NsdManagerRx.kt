package com.cblue.android_nsd.rx

import android.content.Context
import android.net.nsd.NsdManager
import android.net.nsd.NsdServiceInfo
import com.cblue.android_nsd.flow.library.nsd.rx.INsdManagerCompat
import com.cblue.android_nsd.flow.library.nsd.rx.NsdManagerCompat
...
import com.cblue.android_nsd.flow.library.nsd.rx.registration.RegistrationConfiguration
...
import com.cblue.android_nsd.rx.discovery.DiscoveryListenerRx
import com.cblue.android_nsd.rx.registration.RegistrationListenerRx
import com.cblue.android_nsd.rx.resolve.ResolveListenerRx
...
class NsdManagerRx {
    ...
    ): Observable<DiscoveryEvent> =
        Observable.create { emitter: ObservableEmitter<DiscoveryEvent> ->
    ...
    ): Observable<RegistrationEvent> =
        Observable.create { emitter: ObservableEmitter<RegistrationEvent> ->
            val listener = listenerFactory(nsdManagerCompat, emitter)
